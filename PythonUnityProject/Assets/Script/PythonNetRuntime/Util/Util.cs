...
namespace Python.Runtime
{
    internal static partial class Util
    {
        ...
        // BonusGamesHack: Unity的C#版本的字符串需要是常量
        //internal const string UseNone = $"null is not supported in this context. Use {nameof(PyObject)}.{nameof(PyObject.None)}";
        internal const string UseNone = "null is not supported in this context. Use PyObject.None";
