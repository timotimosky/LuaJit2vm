...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        private static readonly Dictionary<MaybeType, PyType> cache = new Dictionary<MaybeType, PyType>();
        ...
        // BonusGamesHack: 函数委托
        private static IntPtr generic_new_ptr;
        ...
        internal static void Initialize()
        {
            ...
            // BonusGamesHack: 创建函数委托
            Delegate generic_new_delegate = new Interop.BBB_N(Runtime.PyType_GenericNew);
            TypeManager.generic_new_ptr = Marshal.GetFunctionPointerForDelegate(generic_new_delegate);
        }
        ...
        internal static unsafe PyType CreateType(Type impl)
        {
            ...
            // BonusGamesHack: 兼容C#7.0的处理方案，转换出IntPtr
            //Util.WriteIntPtr(type, TypeOffset.tp_new, (IntPtr)Runtime.Delegates.PyType_GenericNew);
            // TODO:Mark 这里需要在py3的环境下测试
            Util.WriteIntPtr(type, TypeOffset.tp_new, TypeManager.generic_new_ptr);
    ...
    class SlotsHolder
    {
        ...
        private readonly Dictionary<int, ThunkInfo> _slots = new Dictionary<int, ThunkInfo>();
        private readonly List<ThunkInfo> _keepalive = new List<ThunkInfo>();
        private readonly Dictionary<int, Resetor> _customResetors = new Dictionary<int, Resetor>();
        private readonly List<Action> _deallocators = new List<Action>();
