...
namespace Native
{
    ...
    internal class ExceptionPInvoke
    {
        ...
        [DllImport(DllLoader._dllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CauseUnmanagedExceptions")]
        private extern static void PInvokeCauseUnmanagedExceptions(UnmanagedExceptionType type);

        [DllImport(DllLoader._dllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "ThrowUnmanagedExceptions")]
