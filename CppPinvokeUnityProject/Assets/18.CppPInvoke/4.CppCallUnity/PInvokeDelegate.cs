...
public class PInvokeDelegate : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        libarayHandle = DLLManager.OpenLibrary(Application.dataPath+ "\\Plugins\\x86_64\\" + DLLManager._dllName);
        Init = DLLManager.GetDelegate<InitDelegate>(libarayHandle, "Init");
        MonoBehaviourUpdate = DLLManager.GetDelegate<MonoBehaviourUpdateDelegate>(libarayHandle, "MonoBehaviourUpdate");
#endif
    ...
    {
#if UNITY_EDITOR
        DLLManager.FreeLibrary(libarayHandle);
