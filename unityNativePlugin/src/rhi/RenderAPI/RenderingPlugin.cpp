...
//SetMeshBuffersFromUnity�����ǵ�����һ��ʾ����������������һ���ű����á�
...
extern "C" void UNITY_INTERFACE_EXPORT UNITY_INTERFACE_API SetMeshBuffersFromUnity(void* vertexBufferHandle, int vertexCount, 
	float* sourceVertices, float* sourceNormals, float* sourceUV)
{
	...
	//�ýű�Ҳ����ԭʼԴ�������ݡ�ԭ��������Ҫ�޸ĵĶ��㻺�����������Ϊ"dynamic"��������ƽ̨�ϣ�����ζ������ֻ��д�����������ܶ�ȡ��֮ǰ������
	//����������У����ǲ��Ǵ�ͷ��ʼ�������񣬶��Ǹı�ԭʼ��������
	//�ýű�ֻ�ǽ�ָ�봫�ݸ������c#�������ݡ�
...
static void UNITY_INTERFACE_API OnGraphicsDeviceEvent(UnityGfxDeviceEventType eventType)
{
	// Create graphics API implementation upon initialization�ڳ�ʼ��ʱ����ͼ��APIʵ��
...
static void DrawColoredTriangle()
{
	...
	//��һ����ɫ�����Ρ�ע����D3D��OpenGL��ɫ�᲻ͬ�����磬��Ϊ����������ɫ�ֽ��ڲ�ͬ��˳��
	struct MyVertex
	{
		float x, y, z;
		unsigned int color; //32λ
	};
	MyVertex verts[3] =
	{
...
static void ModifyTexturePixels()
{
	...
	int textureRowPitch; //һ�е������� rgba4 *����
	//��ʹint���ͣ�����ָ�룬Ҳ����ȡ��ַ���õ����ô���ȥ��Ϊָ�룬�൱��C#��ref�������Ժ���Ҫ�ͷ����á�
	...
	for (int y = 0; y < height; ++y)
	{
		...
		{
			// Simple "plasma effect": several combined sine waves �򵥵ġ���������ЧӦ��:������ϵ����Ҳ�
			int vv = int(
...
//GetRenderEventFunc�����ǵ�����һ��ʾ�����������ڻ�ȡ��Ⱦ�¼��ص�������


//ͨ��һ��������װ��Ȼ�󷵻���һ��������ָ�룬��ʵ�ֺ���ί��Ч��
