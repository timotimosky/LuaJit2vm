...
namespace Python.Runtime
{
    ...
    public unsafe partial class Runtime
    {
        ...
        private static readonly List<PyObject> _pyRefs = new List<PyObject>();
        ...
        internal static void Initialize(bool initSigs = false)
        {
            ...
            hexCallable = new Lazy<PyObject>(() => new PyString("%x").GetAttr("__mod__"));
        }
        ...
        private static void InitPyMembers()
        {
            using (var builtinsOwned = PyImport_ImportModule("builtins"))
            {
                ...
                // BonusGamesHack: 这里通过获取None的类型来获取PyType_Type(C-API)，等同于在py中执行type(type(None))
                // 变量末尾加感叹号"!"为C#中的非空断言
                SetPyMemberTypeOf(out __PyTypeType, PyNoneType!);
            ...
            // BonusGamesHack: 添加ByteArray的类型用于运行时判断
            SetPyMemberTypeOf(out PyByteArrayType, PyByteArray_FromStringAndSize("").StealNullable());
...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        // BonusGamesHack: 这里定义一个PyType成员，通过PyObject_Type取到类型
        private static PyType __PyTypeType;
        internal static BorrowedReference PyTypeType => __PyTypeType.BorrowNullable();

        internal static PyObject PyBytesType;
        // BonusGamesHack: 添加ByteArray类型的PyObject
        internal static PyObject PyByteArrayType;
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public static PyObject None => new PyObject(_PyNone);
        ...
        {
            // BonusGamesHack: 需要保证_Py_NewReference一定存在
        ...
        {
            // BonusGamesHack: 需要保证_Py_IsFinalizing一定存在
        ...
        {
            // BonusGamesHack: 需要保证PyIter_Check一定存在
        ...
        [MonoPInvokeCallback(typeof(Interop.BBB_N))]
