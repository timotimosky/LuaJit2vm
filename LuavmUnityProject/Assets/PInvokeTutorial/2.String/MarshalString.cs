...
namespace MarshalString
{
    class MarshalString
    {
        ...
        [DllImport(DllLoader._dllName, CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TestStringArgumentOut")]
        ...
        [DllImport(DllLoader._dllName, CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TestStringAsResult")]
