...
namespace Python.Runtime
{
    ...
    {
        static readonly Dictionary<MethodInfo, Type> delegateTypes = new Dictionary<MethodInfo, Type>();
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate NewReference BSp_N(BorrowedReference ob, StrPtr sptr);
        
        // ============================
        // BonusGamesHack: 补充prototype
        // ======
        // 这里"E_P"的语义是参数为空（Empty）并返回IntPtr
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate IntPtr E_P();
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate NewReference BI32_N(BorrowedReference ob, nint i);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void I_V(int i);
    }
